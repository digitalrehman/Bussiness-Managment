...
import { Add_Data_Dec, sum_Ans } from "../DataStore/MarchKarachi";

const MarchKarachi = () => {
  let { Sumvalue, Sumprofit, Akbar, Anwar } = sum_Ans[0];
  let salary = 103850;
  let akbar_remaining = 154826;
  let anwar_remaining = 173190;
  return (
    <>
        ...
        <div className="row my-3">
          <div className="col-12">
            <div className="text-center">
              <h1 className="fw-bold text-light">March Details</h1>
            </div>
