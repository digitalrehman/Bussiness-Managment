...
import { Add_Data_Dec, sum_Ans } from "../DataStore/febkarachi";

const FebKarachi = () => {
  let { Sumvalue, Sumprofit, Akbar, Anwar } = sum_Ans[0];
  let salary = 97150;
  let akbar_remaining = 140046;
  let anwar_remaining = 159535;
  return (
    <>
        ...
        <div className="row my-3">
          <div className="col-12">
            <div className="text-center">
              <h1 className="fw-bold text-light">February Details</h1>
            </div>
